...
class Message:
    ...
    def reply(self, msg_type, data=None, context=None):
        ...
        # if self.data.get("flac_filename", None) and not self.context.get("flac_filename"):
        #     LOG.error("flac_filename found in data, but not context!!")
        #     new_context["cc_data"] = self.data.get("cc_data", {})
        #     new_context["flac_filename"] = self.data.get("flac_filename", None)
        #     new_context["mobile"] = self.data.get("mobile", False)
        #     new_context["speaker"] = self.data.get("speaker", {})
        #     new_context["nick_profiles"] = self.data.get("nick_profiles", {})
